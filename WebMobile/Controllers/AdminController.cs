    ...
    public class AdminController : BaseController
    {
        ...
        public ActionResult PromoteCouponBuyRecord(PromoteCouponBuyRecordViewModel model)
        {
            ...
            else
            {
                ...
                sql.Append(" where b.BuyTime!=null ");


                if (model.StartTime != null)
                {
                    sql.Append(" and  BuyTime >='" + CommonUtils.ConverToShortDateStart(model.StartTime.Value) + "'"); ;
                }
                if (model.EndTime != null)
                {
                    sql.Append(" and  BuyTime <='" + CommonUtils.ConverToShortDateEnd(model.EndTime.Value) + "'");
                }


                sql.Append(" order by BuyTime desc  ");
